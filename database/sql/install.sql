...
CREATE TABLE `goods` (
  ...
  `delivery_source` tinyint(1) NOT NULL DEFAULT '0' COMMENT '发货来源 0本地卡密 1ShyAPI兑换码',
  `shyapi_name_prefix` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'ShyAPI名称前缀筛选',
  `shyapi_quota` int NOT NULL DEFAULT '0' COMMENT 'ShyAPI固定额度筛选',
  `shyapi_assigned_to` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'shop' COMMENT 'ShyAPI分配渠道',
